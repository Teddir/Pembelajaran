<div class="row">
    <div class="card bg-none ml-5" style="width: 80rem;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="<?= BASEURL; ?>/Artikel/hapus/<?= $kamu['id'] ?>" class="badge badge-danger float-right ml-2" onclick="return confirm('yakin');">Hapus</a>
                                <a href="<?= BASEURL; ?>/Santri/ubah/<?= $kamu['id'] ?>" class="badge badge-primary float-right ml-2 tampilModalUbah1" data-toggle="modal" data-target="#modal" data-id="<?= $kamu['id']; ?>">Update</a>
